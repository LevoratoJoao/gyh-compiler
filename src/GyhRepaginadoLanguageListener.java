...
public interface GyhRepaginadoLanguageListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GyhRepaginadoLanguageParser#expressaoAritmeticaLinha}.
	 * @param ctx the parse tree
	 */
	void enterExpressaoAritmeticaLinha(GyhRepaginadoLanguageParser.ExpressaoAritmeticaLinhaContext ctx);
	/**
	 * Exit a parse tree produced by {@link GyhRepaginadoLanguageParser#expressaoAritmeticaLinha}.
	 * @param ctx the parse tree
	 */
	void exitExpressaoAritmeticaLinha(GyhRepaginadoLanguageParser.ExpressaoAritmeticaLinhaContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link GyhRepaginadoLanguageParser#termoAritmeticoLinha}.
	 * @param ctx the parse tree
	 */
	void enterTermoAritmeticoLinha(GyhRepaginadoLanguageParser.TermoAritmeticoLinhaContext ctx);
	/**
	 * Exit a parse tree produced by {@link GyhRepaginadoLanguageParser#termoAritmeticoLinha}.
	 * @param ctx the parse tree
	 */
	void exitTermoAritmeticoLinha(GyhRepaginadoLanguageParser.TermoAritmeticoLinhaContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link GyhRepaginadoLanguageParser#expressaoRelacionalLinha}.
	 * @param ctx the parse tree
	 */
	void enterExpressaoRelacionalLinha(GyhRepaginadoLanguageParser.ExpressaoRelacionalLinhaContext ctx);
	/**
	 * Exit a parse tree produced by {@link GyhRepaginadoLanguageParser#expressaoRelacionalLinha}.
	 * @param ctx the parse tree
	 */
	void exitExpressaoRelacionalLinha(GyhRepaginadoLanguageParser.ExpressaoRelacionalLinhaContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link GyhRepaginadoLanguageParser#varUse}.
	 * @param ctx the parse tree
	 */
	void enterVarUse(GyhRepaginadoLanguageParser.VarUseContext ctx);
	/**
	 * Exit a parse tree produced by {@link GyhRepaginadoLanguageParser#varUse}.
	 * @param ctx the parse tree
	 */
	void exitVarUse(GyhRepaginadoLanguageParser.VarUseContext ctx);
}